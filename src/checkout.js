...
import { useHistory } from 'react-router-dom'; // Replaced `next/navigation` with `react-router-dom`
...
const CheckoutPage = () => {
    ...
    const history = useHistory(); // Replaced `useRouter` with `useHistory`
    ...
    const handleCheckout = async () => {
        ...
        try {
            ...
            if (response.ok) {
                ...
                history.push('/orders'); // Replaced `router.push` with `history.push`
            } else {
