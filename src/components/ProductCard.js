...
import { addToCart } from '../redux/slices/cartSlices'; // Ensure correct import from your cartSlices.js
...
function ProductCard({ data }) {
  ...
  const handleDetail = (id) => {
    navigate(`/products/${id}`); // Use navigate to go to the product details page
  };
