...
export default function Products() {
  ...
  const fetchProducts = async (page = 1, limit = 2) => {
    try {
      ...
      const processedData = data.result.map((product) => ({
        ...product,
        ...
        <div className="row">
          <div className="col-md-3">
            <div>
              ...
              />
              <label htmlFor="showAll" className="product-hien-1">Hiển thị tất cả</label>
              <br />
              <input
                type="checkbox"
                id="showsale"
                ...
                className="me-2"
              />
              <label htmlFor="showsale" className="product-hien">Sản phẩm sale</label>
              <br />
              <input
                type="checkbox"
                id="showhot"
                ...
                className="me-2"
              />
              <label htmlFor="showhot" className="product-hien">Sản phẩm hot</label>
              <br />
              <input
                type="checkbox"
                id="showbestselling"
                ...
                className="me-2"
              />
              <label htmlFor="showbestselling" className="product-hien">Sản phẩm bán chạy</label>
            </div>
            <br />
            <div>
