...
import "./bootstrap/css/bootstrap.min.css";  // Ensure correct path
import "./bootstrap/css/style.css";
import "./bootstrap/css/danhmuc.css";
import Header from "./components/Header";
import Footer from "./components/Footer";
import Providers from "./redux/provider"; // Ensure correct path for Redux provider
...
const interStyle = { fontFamily: 'Inter', fontWeight: 'normal' };  // Keep inline or move to CSS
...
function App() {
  ...
  return (
    <div style={interStyle}>  {/* Apply global font style */}
      <Providers>
        <Header />
        <>
          <Banner />
      ...
      {/* Include Bootstrap Bundle JS script */}
